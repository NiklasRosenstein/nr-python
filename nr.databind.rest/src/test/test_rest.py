...
def test_http_data():
  assert HttpData.parse('GET /') == HttpData('GET', Path('/'))
...
def test_path():
  ...
  assert Path('/my-endpoint/{myParameter}/{b}/bar').parameters == ['myParameter', 'b']
  assert str(Path('/my-endpoint/{myParameter}/{b}/bar')) == '/my-endpoint/{myParameter}/{b}/bar'
