...
requirements = ['nr.collections >=0.0.1,<0.1.0', 'nr.interface >=0.0.1,<0.1.0', 'nr.parsing.date >=0.0.1,<0.1.0', 'nr.stream >=0.0.1,<0.1.0', 'nr.pylang.utils >=0.0.1,<0.1.0', 'nr.databind.core >=0.0.1,<0.1.0']
extras_require = {}
